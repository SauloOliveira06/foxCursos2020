<div class="row">
    ...
    <div class="col-md-4">
		<blockquote class="blockquote-blue">
			<p>
				<strong>Instrução de Admissão de Estudantes</strong>
			</p>
			<p>
			A admissão de novos alunos irá criar automaticamente uma inscrição para a turma seleccionada na sessão em curso.
				Por favor, verifique e volte a verificar as informações que você inseriu porque uma vez que você admitir um novo aluno, você não será capaz
				para editar a sua aula, rolar, seção sem promover para a próxima sessão.
			</p>
		</blockquote>
	</div>
