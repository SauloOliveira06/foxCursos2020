...
<div class="row">
    <div class="col-md-12">
        <blockquote class="blockquote-blue">
            <p>
                <strong>Instrução de Promoção Estudantil</strong>
            </p>
            <p>
            A promoção do aluno da classe atual para a classe seguinte criará uma matrícula desse aluno para
                na próxima sessão. Certifique-se de selecionar as opções corretas de classe no menu de seleção antes de promover.
                para promover um aluno para a próxima aula, por favor selecione essa opção. Isso não irá promover o aluno para a próxima turma.
                mas vai criar uma inscrição para a próxima sessão, mas na mesma turma.
            </p>
        </blockquote>
    </div>
</div>
